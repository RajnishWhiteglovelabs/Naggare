...
export default function Landing() {
  ...
  if (checking) return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="text-sm" style={{color:'#3C3489',fontFamily:'Georgia,serif'}}>Loading Naggare...</div>
    </div>
  )
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 text-center bg-white">
      ...
      <p className="text-lg mb-14 max-w-sm leading-relaxed italic" style={{color:'#4B5563',fontFamily:'Georgia,serif'}}>
